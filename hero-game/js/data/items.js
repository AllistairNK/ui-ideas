export const ITEM_TEMPLATES = {
  ...
  // --- Mechanic line tiered weapons (dagger/bow/staff/gauntlet/gun), one set
  // per class tier -- Novice Mechanic through Clockwork Divinity. Not yet
  // wired into LOOT_TABLES or SHOP_ITEM_IDS; acquisition still needs a
  // tier-gated drop/shop path.
  socket_shiv: {
  ...
  piston_blade: {
    ...
    rarity: 'uncommon', element: 'lightning',
...
export const SHOP_ITEM_IDS = [
  'rusty_sword', 'hunting_bow', 'apprentice_staff', 'tinkers_gauntlet', 'scrap_pistol', 'leather_cap',
